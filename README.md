...
覆盖三类金融数据的**全自动采集**：衍生品全量数据、个股资金流明细、大盘盘口指标。三条线全部无人值守，输出结构化表格，可直接进入分析 / 建模环节。

| | 数据类别 | 采集频次 | 技术路线 | 难度 |
|:--:|---|---|---|:--:|
| **①** | 大盘盘口指标 | 每日 **49** 个时点 | 截图 + 点阵模板匹配 + 布局指纹 | ⭐⭐⭐⭐⭐ |
| **②** | 衍生品全量数据 | 每日 **7** 个时点 | RPA + 图像定位 | ⭐⭐⭐⭐ |
| **③** | 个股资金流明细 | 每日 **18** 个时点 | 终端内置导出 + 键盘导航 | ⭐⭐⭐ |

> 按**技术难度递减**排列——因为读者的注意力是递减的。
...
<details>
<summary><b>ⓘ 展开：6 个核心难点与破局</b></summary>
